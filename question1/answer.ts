...
const blueBikes = getMatches<Bicycle>(bicycleShed, (b) => b.color == "Blue")
console.log(blueBikes)

const redCars = getMatches<Car>(carpark, (b) => b.color == "Red")
console.log(redCars)

const blueCars = getMatches<Car>(carpark, (b) => b.color == "Blue" )
